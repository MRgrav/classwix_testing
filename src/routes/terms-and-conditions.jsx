...
export default function TermsNconditions() {
  return (
    <div class='min-h-100 px-6 md:px-10 lg:px-16 pb-16 pt-24'>
        <h2 class="text-lg font-bold mt-6 mb-3">Terms & Conditions</h2>
        <p class="mb-4 text-sm">
        CLASSWiX is a global learning platform transforming lives through education and music. A subsidiary of Bipransh EdTech Private Limited.
        </p>
        <p class="mb-4 text-sm">
        This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://www.classwix.com/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
        </p>
        <p class="mb-4 text-sm">
        The Platform is owned by BIPRANSH EDTECH PRIVATE LIMITED, a company incorporated under the Companies Act, 1956 with its registered office at Vill 2 No Gedarbori, Jamuguri, Nagaon, Nagaon, Assam, India, 782142 ,Nagaon ,India (hereinafter referred to as ?Platform Owner?, 'we', 'us', 'our').
        </p>
        <p class="mb-4 text-sm">
        ...
        <p class="mb-4 text-sm">
          All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Nagaon and Assam.
        </p>
        <p class="mb-4 text-sm">
          All concerns or communications relating to these Terms must be communicated to us using the contact information provided on this website
        </p>
        <h2 class="text-lg font-bold mt-6 mb-3">
          Privacy Policy
        </h2>
        <p class="mb-4 text-sm">
          Introduction
        ...
        <p class="mb-4 text-sm">
          This refund and cancellation policy outlines how you can cancel or seek a refund for service that you have purchased through the Platform. Under this policy:
        </p>
        <p class="mb-4 text-sm">
          Cancellations will only be considered if the request is made 5 days after placing the order. 
        </p>
        <p class="mb-4 text-sm">
          In case of any refunds approved by BIPRANSH EDTECH PRIVATE LIMITED, it will take 7 days for the refund to be processed to you.
        </p>
    </div>
  )
}
